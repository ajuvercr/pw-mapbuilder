...
export function closure904_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__heff825d6551d1eac(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he0f92f3f3230712c(a: number, b: number): void;
export function closure15309_externref_shim(a: number, b: number, c: number): void;
